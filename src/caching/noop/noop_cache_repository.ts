...
import NoopCacheItem from './noop_cache_item';
...
/**
 * A cache repository that does nothing.
 */
export default class NoopCacheRepository extends BaseCacheRepository {
  /**
   ...
   */
  protected _constructCacheItem(key: string, ttl?: number): NoopCacheItem {
    return new NoopCacheItem(key, ttl);
  }
}
