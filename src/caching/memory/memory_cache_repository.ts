 ...
 */
export default class MemoryCacheRepository extends BaseCacheRepository {
  /**
   * Constructs a new MemoryCacheRepository instance
   ...
   */
  protected _constructCacheItem(key: string, ttl?: number): MemoryCacheItem {
    return new MemoryCacheItem(key, ttl);
  }
}
